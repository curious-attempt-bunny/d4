...
d4.js: $(shell node_modules/.bin/smash --list src/d4.js) package.json
	@rm -f $@
	node_modules/.bin/smash src/d4.js | node_modules/.bin/uglifyjs - -b indent-level=2 -o $@
	@chmod a-w $@
...
component.json: bin/component d4.js package.json
	@rm -f $@
	bin/component > $@
	@chmod a-w $@
