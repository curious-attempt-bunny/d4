d3 = function() {
  ...
  d3.behavior.zoom = function() {
    var translate = [ 0, 0 ], translate0, distance0, scale = 1, scale0, scaleExtent = d3_behavior_zoomInfinity, event = d3_eventDispatch(zoom, "zoom"), x0, x1, y0, y1, touchtime;
    function zoom() {
    ...
    function touchstart() {
      ...
      if (touches.length === 1) {
        ...
        distance0 = Math.sqrt(dx * dx + dy * dy);
      }
    }
    function touchmove() {
